                                        ...
                                        <?php if(count($order->orderDetails) > 0): ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <a class="btn btn-soft-warning btn-icon btn-circle btn-sm" href="<?php echo e(route('customer.invoice.download', $order->id)); ?>" title="<?php echo e(translate('Download Invoice')); ?>">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shebaco1/public_html/resources/views/frontend/user/purchase_history.blade.php ENDPATH**/ ?>