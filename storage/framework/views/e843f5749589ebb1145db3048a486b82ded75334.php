...
<head>
    ...
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Lato:300,300i,400,400i,600,600i,700,700i,800,800i,900,900i&display=swap" rel="stylesheet">
...
<?php if(\App\BusinessSetting::where('type', 'facebook_pixel')->first()->value == 1): ?>
    ...
    <script>
    	...
    	fbq('init', '1167591363973977');
    	fbq('track', 'PageView');
    </script>
    <noscript>
     <img height="1" width="1" src="https://www.facebook.com/tr?id=1167591363973977&ev=PageView &noscript=1"/>
    </noscript>
...
<?php /**PATH C:\xampp\htdocs\SHEBA_FINAL\resources\views/frontend/layouts/app.blade.php ENDPATH**/ ?>