                ...
                <form class="form-default" role="form" action="<?php echo e(route('addresses.store')); ?>" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="p-3">
                            ...
                            <div class="row">
                                <label class="col-md-2 col-form-label"><?php echo e(translate('City')); ?></label>
                                <div class="col-md-10">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shebaco1/public_html/resources/views/frontend/user/customer/profile.blade.php ENDPATH**/ ?>