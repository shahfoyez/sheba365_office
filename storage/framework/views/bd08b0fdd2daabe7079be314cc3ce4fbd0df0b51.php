<div class="aiz-category-menu bg-white rounded shadow-lg" id="category-sidebar">
    ...
    <ul class="list-unstyled categories no-scrollbar py-2 mb-0 text-left">
        <?php $__currentLoopData = \App\Category::where('level', 0)->get()->take(11); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\SHEBA_FINAL\resources\views/frontend/partials/category_menu.blade.php ENDPATH**/ ?>