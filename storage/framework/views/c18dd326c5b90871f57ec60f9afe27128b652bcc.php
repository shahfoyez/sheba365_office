                ...
                <form class="form-default" action="<?php echo e(route('checkout.store_delivery_info')); ?>" role="form" method="POST">
                    ...
                    <div class="card mb-3 shadow-sm border-0 rounded">
                        ...
                        <div class="card-footer justify-content-end">
                            <button type="submit" name="owner_id" value="<?php echo e(App\User::where('user_type', 'admin')->first()->id); ?>" class="btn fw-600 btn-primary"><?php echo e(translate('Continue to Payment')); ?></a>
                        </div>
                    </div>
                </form>
                <?php endif; ?>
                <form class="form-default"  action="<?php echo e(route('checkout.store_delivery_info')); ?>" role="form" method="POST">
                    ...
                    <?php if(!empty($seller_products)): ?>
                        <?php $__currentLoopData = $seller_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $seller_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="card mb-3 shadow-sm border-0 rounded">
                                <div class="card-header p-3">
                                    <h5 class="fs-16 fw-600 mb-0"><?php echo e(\App\Shop::where('user_id', $key)->first()->name); ?> <?php echo e(translate('Products')); ?></h5>
                                </div>
                                <div class="card-body">
                                    <ul class="list-group list-group-flush">
                                ...
                                <div class="card-footer justify-content-end">
                                    <button type="submit" name="owner_id" value="<?php echo e($key); ?>" class="btn fw-600 btn-primary"><?php echo e(translate('Continue to Payment')); ?></a>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shebaco1/public_html/resources/views/frontend/delivery_info.blade.php ENDPATH**/ ?>