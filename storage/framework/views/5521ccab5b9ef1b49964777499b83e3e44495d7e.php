        ...
        <div class="card shadow-none border-0">
            <ul class="list-unstyled mb-3">
                <li class="fw-600 border-bottom pb-2 mb-3">
                    <a class="text-reset" href="<?php echo e(route('products.category', \App\Category::find($first_level_id)->slug)); ?>"><?php echo e(\App\Category::find($first_level_id)->getTranslation('name')); ?></a>
                </li>
...
<?php /**PATH C:\xampp\htdocs\SHEBA_FINAL\resources\views/frontend/partials/category_elements.blade.php ENDPATH**/ ?>