                        ...
                        <div class="text-left">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6 text-right">
                                    ...
                                    <?php else: ?>
                                        <span class="badge badge-md badge-inline badge-pill badge-danger"><?php echo e(translate('Out of stock')); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <form id="option-choice-form">
                                ...
                                <?php if($detailedProduct->choice_options != null): ?>
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-sm-2">
                                            <div class="opacity-50 my-2"><?php echo e(\App\Attribute::find($choice->attribute_id)->getTranslation('name')); ?>:</div>
                                        </div>
                                        <div class="col-sm-10">
                                ...
                                <li class="py-3 px-0 list-group-item border-light">
                                    <div class="row gutters-10 align-items-center">
                                        ...
                                        <div class="col-7 text-left">
                                            ...
                                            <div class="mt-2">
                                                <span class="fs-17 fw-600 text-primary"><?php echo e(home_discounted_base_price($top_product->id)); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                        ...
                                        <div class="p-md-3 p-2 text-left">
                                            <div class="fs-15">
                                                <?php if(home_base_price($related_product->id) != home_discounted_base_price($related_product->id)): ?>
                                                    <del class="fw-600 opacity-50 mr-1"><?php echo e(home_base_price($related_product->id)); ?></del>
                                                <?php endif; ?>
                                                <span class="fw-700 text-primary"><?php echo e(home_discounted_base_price($related_product->id)); ?></span>
                                            </div>
                                            <div class="rating rating-sm mt-1">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SHEBA_FINAL\resources\views/frontend/product_details.blade.php ENDPATH**/ ?>