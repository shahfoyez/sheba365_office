                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="text-left">
                            <div class="d-flex">
                                ...
                                <div class="form-group ml-2 mr-0 w-200px d-none d-md-block">
                                    <label class="mb-0 opacity-50"><?php echo e(translate('Sellers')); ?></label>
                        ...
                        <div class="row gutters-5 row-cols-xxl-4 row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-2">
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col mb-3">
                                    <div class="aiz-card-box h-100 border border-alter border-width-2">
                                        ...
                                        <div class="p-md-3 p-2 text-center bg-alter">
                                            <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SHEBA_FINAL\resources\views/frontend/product_listing.blade.php ENDPATH**/ ?>