                ...
                <div class="aiz-user-panel">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="<?php echo e(route('pdf.download_category')); ?>"><button class="btn btn-primary mt-2"><?php echo e(translate('Download Category')); ?></button></a>
                            <a href="<?php echo e(route('pdf.download_brand')); ?>"><button class="btn btn-primary mt-2"><?php echo e(translate('Download Brand')); ?></button></a>
                        </div>
                    </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shebaco1/public_html/resources/views/frontend/user/seller/product_bulk_upload/index.blade.php ENDPATH**/ ?>