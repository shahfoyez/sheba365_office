...
<?php $__currentLoopData = $combinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $combination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	<?php if(strlen($str) > 0): ?>
		<tr class="variant">
			...
			<td>
				<input type="number" lang="en" name="purchase_price_<?php echo e($str); ?>" value="<?php
...
<?php endif; ?>
<?php /**PATH /home/shebaco1/public_html/resources/views/backend/product/products/sku_combinations_edit.blade.php ENDPATH**/ ?>