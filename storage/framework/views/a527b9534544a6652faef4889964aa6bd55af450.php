        ...
        <div class="card-body">
            <form action="<?php echo e(route('sellers.store')); ?>" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="<?php echo e(translate('Email Address')); ?>" id="email" name="email" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SHEBA_FINAL\resources\views/backend/sellers/create.blade.php ENDPATH**/ ?>