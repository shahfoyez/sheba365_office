                ...
                <div class="col-lg-7">
                    ...
                    <div class="pos-footer mar-btm">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="">
                                <button type="button" class="btn btn-styled btn-success" data-target="#order-confirm" data-toggle="modal"><?php echo e(translate('Pay With Cash')); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-dismiss="modal" id="close-button"><?php echo e(translate('Close')); ?></button>
                    <button type="button" class="btn btn-primary" data-dismiss="modal"><?php echo e(translate('Confirm')); ?></button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class=" row">
                                ...
                                <div class="col-sm-10">
                                    <select name="country" id="country" class="form-control selectpicker" data-live-search="true" required data-placeholder="<?php echo e(translate('Select country')); ?>">
    ...
    <div id="order-confirm" class="modal fade">
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom">
            <div class="modal-content" id="variants"><div class="modal-header">
                ...
                <div class="modal-body">
                    <h4><?php echo e(translate('Are you sure to confirm this order?')); ?></h4>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-dismiss="modal"><?php echo e(translate('Close')); ?></button>
                    <button type="button" onclick="submitOrder('cash')" class="btn btn-primary"><?php echo e(translate('Comfirm Order')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        function getShippingAddress(){
            $.post('<?php echo e(route('pos.getShippingAddressForSeller')); ?>',{_token:'<?php echo e(csrf_token()); ?>', id:$('select[name=user_id]').val()}, function(data){
        ...
        function submitOrder(payment_type){
            ...
            $.post('<?php echo e(route('pos.order_place')); ?>',{_token:'<?php echo e(csrf_token()); ?>', user_id:user_id, name:name, email:email, address:address, country:country, postal_code:postal_code, phone:phone, payment_type:payment_type, shipping:shipping, discount:discount, shipping_address:address }, function(data){
                if(data == 1){
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shebaco1/public_html/resources/views/pos/frontend/seller/pos/index.blade.php ENDPATH**/ ?>