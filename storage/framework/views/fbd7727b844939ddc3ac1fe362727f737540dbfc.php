            ...
            <div class="d-flex align-items-start">
                ...
                <div class="aiz-user-panel">
                    ...
                    <div class="row gutters-10 justify-content-center">
                            ...
                            <div class="col-md-4 mx-auto mb-3" >
                                <div class="bg-grad-1 text-white rounded-lg overflow-hidden">
                                  ...
                                  <div class="px-3 pt-3 pb-3">
                                      <div class="h4 fw-700 text-center"><?php echo e(max(0, Auth::user()->seller->remaining_digital_uploads)); ?></div>
                        ...
                        <div class="col-md-4 mx-auto mb-3" >
                            <a href="<?php echo e(route('seller.digitalproducts.upload')); ?>">
                              <div class="p-3 rounded mb-3 c-pointer text-center bg-white shadow-sm hov-shadow-lg has-transition">
                                  <span class="size-60px rounded-circle mx-auto bg-secondary d-flex align-items-center justify-content-center mb-3">
                                      <i class="las la-plus la-3x text-white"></i>
                                  </span>
                                  <div class="fs-18 text-primary"><?php echo e(translate('Add New Digital Product')); ?></div>
                              </div>
                            </a>
                        </div>
                            ...
                            <table class="table aiz-table mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-breakpoints="md"><?php echo e(translate('Base Price')); ?></th>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo e(route('product', $product->slug)); ?>" target="_blank"><?php echo e($product->getTranslation('name')); ?></a></td>
                                            <td>
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo e(route('seller.digitalproducts.edit',  ['id'=>$product->id, 'lang'=>env('DEFAULT_LANGUAGE')] )); ?>" class="btn btn-soft-info btn-icon btn-circle btn-sm" title="<?php echo e(translate('Edit')); ?>">
                                                  <i class="las la-edit"></i>
                                                </a>
                                                <a class="btn btn-soft-success btn-icon btn-circle btn-sm" href="<?php echo e(route('digitalproducts.download', encrypt($product->id))); ?>" title="<?php echo e(translate('Download')); ?>">
                                                    <i class="las la-download"></i>
                                                </a>
                                                <a href="javascript:void(0)" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="<?php echo e(route('digitalproducts.destroy', $product->id)); ?>" title="<?php echo e(translate('Delete')); ?>">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shebaco1/public_html/resources/views/frontend/user/seller/digitalproducts/products.blade.php ENDPATH**/ ?>