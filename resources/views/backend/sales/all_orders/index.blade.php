            ...
            <tbody>
                @foreach ($orders as $key => $order)
                    <tr>
                        ...
                        @endif
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="javascript:void(0)" onclick="print_small_invoice('{{ route('admin.invoice.print',$order->id) }}')" title="{{ translate('Print small invoice') }}">
