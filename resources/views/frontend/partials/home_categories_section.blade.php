    ...
    <section class="pt-5 bg-white">
        <div class="container">
            <div class="separator separator-alter mb-4">
                <span class="bg-white px-5 h4 fw-900">{{ $category->getTranslation('name') }}</span>
            </div>
            ...
            <div class="text-center mt-4">
                <a href="{{ route('products.category', $category->slug) }}" class="btn btn-primary rounded-0 text-uppercase">{{ translate('View All') }}</a>
            </div>
        </div>
    </section>
@endforeach
